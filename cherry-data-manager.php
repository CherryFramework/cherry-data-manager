...
if ( !class_exists('cherry_data_manager') ) {
	...
	class cherry_data_manager {
		...
		function assets() {
			...
			if ( $this->is_manager_page( $this->import_page ) ) {
				...
				$import_texts = array(
					...
					'generate_attachment_metadata_step_3' => __( 'Generate attachements meta. Resizing. This may take some time. Please wait.', $this->slug ),
					'generate_attachment_metadata_step_4' => __( 'Generate attachements meta. Cropping. This may take some time. Please wait.', $this->slug ),
					'generate_attachment_metadata_step_5' => __( 'Generate attachements meta. Finishing. This may take some time. Please wait.', $this->slug ),
		...
		function constants() {
			 ...
			 * @since 1.0.0
			 */
			define( 'CHERRY_DATA_MANAGER_VERSION', '1.0.2' );
