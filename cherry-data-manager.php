...
if ( !class_exists('cherry_data_manager') ) {
	...
	class cherry_data_manager {
		...
		function assets() {
			...
			if ( $this->is_manager_page( $this->import_page ) ) {
				...
				$import_texts = array(
					...
					'import_attachment_metadata'   => __( 'Importing attachments meta.', $this->slug ),
					'generate_attachment_metadata_step_1' => __( 'Generate attachments meta. Preparing. This may take some time. Please wait.', $this->slug ),
					'generate_attachment_metadata_step_2' => __( 'Generate attachments meta. Processing. This may take some time. Please wait.', $this->slug ),
					'generate_attachment_metadata_step_3' => __( 'Generate attachments meta. Finishing. This may take some time. Please wait.', $this->slug ),
					'generate_attachment_metadata_step_4' => __( 'Cropping attachments meta. Preparing. This may take some time. Please wait.', $this->slug ),
					'generate_attachment_metadata_step_5' => __( 'Cropping attachments meta. Processing. This may take some time. Please wait.', $this->slug ),
					'generate_attachment_metadata_step_6' => __( 'Cropping attachments meta. Finishing. This may take some time. Please wait.', $this->slug ),
		...
		function constants() {
			 ...
			 * @since 1.0.0
			 */
			define( 'CHERRY_DATA_MANAGER_VERSION', '1.0.6' );
