...
<div class="wrap">
	<div class="<?php echo $cherry_data_manager->ui_wrapper_class( array( 'cherry-wizard_' ) ); ?>">
		...
		<div class="box-default_ content-wrap_">
			...
			<?php _e( 'Please, install "Sample data" in order to make your website looks exactly as our live demo including all images, pages, layout options etc.', $cherry_data_manager->slug ); ?>
		</div>
